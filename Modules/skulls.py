...
from mapping import skulls
from Modules.display_object import DisplayObject

SHIP_COLOR = (51, 0, 121, 255)  # The color we want the indicator circle to be
FONT_SIZE = 10
CIRCLE_SIZE = 2  # The size of the indicator circle we want
COORD_OFFSET = 0x100


class Skull(DisplayObject):
    """
    ...
    def __init__(self, memory_reader, actor_id, address, my_coords, raw_name):
        ...
        self.name = skulls.get(self.raw_name).get("Name")

...
from mapping import tomes
from Modules.display_object import DisplayObject

SHIP_COLOR = (25, 0, 51, 255)  # The color we want the indicator circle to be
FONT_SIZE = 10
CIRCLE_SIZE = 2  # The size of the indicator circle we want
COORD_OFFSET = 0x100


class Tome(DisplayObject):
    """
    ...
    def __init__(self, memory_reader, actor_id, address, my_coords, raw_name):
        ...
        self.name = tomes.get(self.raw_name).get("Name")

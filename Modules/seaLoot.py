...
from mapping import seaLoot
from Modules.display_object import DisplayObject

SHIP_COLOR = (0, 100, 100)  # The color we want the indicator circle to be
CIRCLE_SIZE = 2  # The size of the indicator circle we want
COORD_OFFSET = 0x100


class SeaLoot(DisplayObject):
    """
    ...
    def __init__(self, memory_reader, actor_id, address, my_coords, raw_name):
        ...
        self.name = seaLoot.get(self.raw_name).get("Name")

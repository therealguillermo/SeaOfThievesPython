...
from mapping import flags
from Modules.display_object import DisplayObject

SHIP_COLOR = (204, 204, 255, 255)  # The color we want the indicator circle to be
FONT_SIZE = 10
CIRCLE_SIZE = 2  # The size of the indicator circle we want
COORD_OFFSET = 0x100


class Flag(DisplayObject):
    """
    ...
    def __init__(self, memory_reader, actor_id, address, my_coords, raw_name):
        ...
        self.name = flags.get(self.raw_name).get("Name")
